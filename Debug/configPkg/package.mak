...
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/ITarget.xs
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/C28_large.xs
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/C28_float.xs
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/package.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/package.xs
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/arm/elf/IArm.xs
C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/arm/elf/package.xs:
package.mak: C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/arm/elf/package.xs
...
ti.targets.arm.elf.packageBase ?= C:/ti/simplelink_cc13x2_26x2_sdk_4_20_00_35/kernel/tirtos/packages/ti/targets/arm/elf/
...
.dlls,em4f .dlls: ble_custom.pem4f

-include package/cfg/ble_custom_pem4f.mak
-include package/cfg/ble_custom_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/ble_custom_pem4f.dep
endif
ble_custom.pem4f: package/cfg/ble_custom_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
ble_custom.pem4f package/cfg/ble_custom_pem4f.c: .libraries,em4f
endif

package/cfg/ble_custom_pem4f.c package/cfg/ble_custom_pem4f.h package/cfg/ble_custom_pem4f.xdl: override _PROG_NAME := ble_custom.xem4f
package/cfg/ble_custom_pem4f.c: package/cfg/ble_custom_pem4f.cfg
package/cfg/ble_custom_pem4f.xdc.inc: package/cfg/ble_custom_pem4f.xdl
package/cfg/ble_custom_pem4f.xdl package/cfg/ble_custom_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/ble_custom_pem4f.cfg
	-$(RM) package/cfg/ble_custom_pem4f.dep
	-$(RM) package/cfg/ble_custom_pem4f.c
	-$(RM) package/cfg/ble_custom_pem4f.xdc.inc

clean,em4f::
	-$(RM) ble_custom.pem4f
.executables,em4f .executables: ble_custom.xem4f

ble_custom.xem4f: |ble_custom.pem4f

-include package/cfg/ble_custom.xem4f.mak
ble_custom.xem4f: package/cfg/ble_custom_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/ble_custom_pem4f.oem4f   package/cfg/ble_custom_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
ble_custom.xem4f: export C_DIR=
ble_custom.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
ble_custom.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

ble_custom.test test,em4f test: ble_custom.xem4f.test

ble_custom.xem4f.test:: ble_custom.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 ble_custom.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.ble_custom.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,ble_custom.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
ble_custom_pem4f.oem4f,copy : package/cfg/ble_custom_pem4f.oem4f
ble_custom_pem4f.sem4f,copy : package/cfg/ble_custom_pem4f.sem4f
